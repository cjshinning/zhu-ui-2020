<template>
  <ul class="zh-pagination">
    <li><zh-icon icon="back" @click="select(currentPage - 1)"></zh-icon></li>
    <li>
    ...
    <li>
      <span :class="{ active: currentPage === total }" @click="select(total)">{{
        total
      }}</span>
    </li>
    <li><zh-icon icon="right" @click="select(currentPage + 1)"></zh-icon></li>
  </ul>
</template>
